  ...
  return (
    <div className="w-full h-full flex flex-col text-white" style={{ backgroundColor: '#2E2E37' }}>
      ...
      <div className="flex-1 overflow-y-auto p-4" style={{ paddingBottom: '150px' }}>
        {/* 로봇 카드 */}
        <div className="bg-app-card rounded-lg p-4 mb-4 shadow-md" style={{ backgroundColor: '#373738' }}>
        ...
        {/* 알림 카드 */}
        <div className="bg-app-card rounded-lg p-4 mt-4 shadow-md" style={{ backgroundColor: '#373738' }}>
...
const StatusCard = ({ icon, title, subtitle, content }: StatusCardProps) => (
  <div className="bg-app-card rounded-lg p-4 shadow-md" style={{ backgroundColor: '#373738' }}>
    <div className="flex flex-col items-center">
      {icon}
