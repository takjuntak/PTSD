  ...
  const getModalContent = () => {
    ...
    switch (modalType) {
      case 'agree1': return common('(필수) 서비스 이용약관 동의', '서비스 이용약관 동의', [
        '본 약관은 사용자가 PTSD 앱(이하 "서비스")을 \n이용함에 있어 회사와 사용자 간의 권리, 의무, \n책임사항 및 기타 필요한 사항을 규정합니다.', '',
        '사용자는 서비스에 회원가임함으로써 본 약관의 \n내용을 모두 이해하고 동의한 것으로 간주됩니다.',
        '회사는 서비스의 내용, 제공 조건, 중단 또는 변경에 \n관한 권한을 가질 수 있습니다.',
        '사용자는 타인의 정보를 도용하거나 서비스 운영을 \n방해해서는 안 됩니다.',
        '※ 전체 약관은 [전체 이용약관 보기] 버튼을 통해 \n확인하실 수 있습니다.',
      ]);
      ...
      case 'agree3': return common('(필수) 위치 정보 수집 및 이용 동의', '위치 정보 수집 및 이용 동의', [
        '[ 수집 항목 ]', '단말기의 GPS 또는 네트워크를 통해 수집된 \n위치 정보', '',
